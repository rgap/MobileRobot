...
void RobotVision::applyFillOcclusion(Mat &world) {
	depthSensing->fillOcclusion(world, 0, 0);
}

void RobotVision::applyDepthRefinement(Mat &world) {
	depthSensing->dispMapRefinement(world);
}
